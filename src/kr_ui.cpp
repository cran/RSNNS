...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int SnnsCLib::krui_getNoOfUnits(void)
{
    return( NoOfUnits );
}
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getFirstUnit(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNextUnit(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getCurrentUnit(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setCurrentUnit(int unit_no)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
char  *SnnsCLib::krui_getUnitName(int UnitNo)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setUnitName(int unit_no, char *unit_name)
{
    struct Unit   *unit_ptr;
    char    *str_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_searchUnitName(char *unit_name)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_searchNextUnitName(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setUnitOutFunc(int unit_no, char *unitOutFuncName)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
char  *SnnsCLib::krui_getUnitFTypeName(int UnitNo)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
FlintType  SnnsCLib::krui_getUnitActivation(int UnitNo)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setUnitActivation(int UnitNo, FlintTypeParam unit_activation)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
FlintType  SnnsCLib::krui_getUnitInitialActivation(int UnitNo)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_setUnitInitialActivation(int UnitNo, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
FlintType  SnnsCLib::krui_getUnitOutput(int UnitNo)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setUnitOutput(int unit_no, FlintTypeParam unit_output)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
FlintType  SnnsCLib::krui_getUnitBias(int UnitNo)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_setUnitBias(int UnitNo, FlintTypeParam unit_bias)
{
...
/****************************************************************************
  ...
  UPDATE   :
****************************************************************************/
FlintType  SnnsCLib::krui_getUnitValueA(int UnitNo)
{
...
/******************************************************************************
  ...
  UPDATE   :
*****************************************************************************/
void  SnnsCLib::krui_setUnitValueA(int UnitNo, FlintTypeParam unit_valueA)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getUnitSubnetNo(int UnitNo)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_setUnitSubnetNo(int UnitNo, int subnet_no)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
unsigned short  SnnsCLib::krui_getUnitLayerNo(int UnitNo)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void    SnnsCLib::krui_setUnitLayerNo(int UnitNo, int layer_no)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void    SnnsCLib::krui_getUnitPosition(int UnitNo, struct PosType *position)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void    SnnsCLib::krui_setUnitPosition(int UnitNo, struct PosType *position)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getUnitTType(int unit_no)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setUnitTType(int unit_no, int UnitTType)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_freezeUnit(int unit_no)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_unfreezeUnit(int unit_no)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_isUnitFrozen(int unit_no)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getUnitInputType(int unit_no)
{
    struct Unit  *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_createDefaultUnit(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_createUnit(char *unit_name, char *out_func_name, char *act_func_name,
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_deleteUnit(int unit_no)
{
    struct  Unit      *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_deleteUnitList(int no_of_units, int unit_list[])
{
    struct  Unit      *unit_ptr;
    int               i;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_createFTypeUnit(char *Ftype_symbol)
{
    int     unit_no;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setUnitFType(int unit_no, char *Ftype_symbol)
{
    struct  Unit      *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int   SnnsCLib::krui_copyUnit(int unit_no, int copy_mode)
{
    int   new_unit_no;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_setFirstFTypeEntry(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_setNextFTypeEntry(void)
{
    struct  FtypeUnitStruct   *ftype_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_setFTypeEntry(char *Ftype_symbol)
{
    struct  FtypeUnitStruct   *ftype_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
char  *SnnsCLib::krui_getFTypeName(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setFTypeName(char *Ftype_symbol)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setFTypeActFunc(char *act_func_name)
{
    FunctionPtr  act_func_ptr, act_deriv_func_ptr, act_2_deriv_func_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err   SnnsCLib::krui_setFTypeOutFunc(char *out_func_name)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_setFirstFTypeSite(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_setNextFTypeSite(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
char  *SnnsCLib::krui_getFTypeSiteName(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setFTypeSiteName(char *FType_site_name)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_createFTypeEntry(char *Ftype_symbol, char *act_func_name, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err    SnnsCLib::krui_deleteFTypeEntry(char *Ftype_symbol)
{
    struct  FtypeUnitStruct   *ftype_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNoOfFunctions(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_isFunction(char *func_name, int func_type)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool   SnnsCLib::krui_getFirstSiteTableEntry(char **site_name, char **site_func)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_getNextSiteTableEntry(char **site_name, char **site_func)
{
    struct  SiteTable   *s_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
char  *SnnsCLib::krui_getSiteTableFuncName(char *site_name)
{
    struct SiteTable  *s_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_createSiteTableEntry(char *site_name, char *site_func)
{
    FunctionPtr   func_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_changeSiteTableEntry(char *old_site_name, char *new_site_name, 
				    char *new_site_func)
{
    FunctionPtr   func_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_deleteSiteTableEntry(char *site_name)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_setFirstSite(void)
{
    if KERNEL_STANDARD
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_setNextSite(void)
{
    if KERNEL_STANDARD
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setSite(char *site_name)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
FlintType   SnnsCLib::krui_getSiteValue(void)
{
    ...
    if KERNEL_STANDARD  {
        if (sitePtr == NULL)
            ...
            return( (this->*sitePtr->site_table->site_func) (sitePtr) );
    }else
        KernelErrorCode = KRERR_SITES_NO_SUPPORT;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
char  *SnnsCLib::krui_getSiteName(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setSiteName(char *site_name)
{
    struct  SiteTable     *stbl_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_addSite(char *site_name)
{
    FlagWord    flags;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_deleteSite(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getFirstPredUnit(FlintType *strength)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getFirstPredUnitAndData(FlintType *strength,float *val_a,
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNextPredUnit(FlintType *strength)
{
    float dummy1,dummy2,dummy3;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNextPredUnitAndData(FlintType *strength,float *val_a,
				 float *val_b, float *val_c)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getCurrentPredUnit(FlintType *strength)
{
    float dummy1,dummy2,dummy3;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getFirstSuccUnit(int source_unit_no, FlintType *weight)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNextSuccUnit(FlintType *weight)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_areConnectedWeight(int source_unit_no, int target_unit_no, 
			      FlintType *weight)
{
    if KERNEL_STANDARD  {
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_isConnected(int source_unit_no)
{
    FlintType  weight;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
FlintType  SnnsCLib::krui_getLinkWeight(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_setLinkWeight(FlintTypeParam weight)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_createLink(int source_unit_no, FlintTypeParam weight)
{
...
******************************************************************************/
struct Link*  SnnsCLib::krui_createLinkWithAdditionalParameters(int source_unit_no, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_deleteLink(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_deleteAllInputLinks(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_deleteAllOutputLinks(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_jogWeights(FlintTypeParam minus, FlintTypeParam plus)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_jogCorrWeights(FlintTypeParam minus, FlintTypeParam plus,
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_setRemapFunc(char *name, float *params)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err   SnnsCLib::krui_setUpdateFunc(char *update_func)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_updateNet(float *parameterInArray, int NoOfInParams)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
char  *SnnsCLib::krui_getInitialisationFunc(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err   SnnsCLib::krui_setInitialisationFunc(char *initialisation_func)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_initializeNet(float *parameterInArray, int NoOfInParams)
{
//Rprintf("krui_initializeNet1\n");
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err   SnnsCLib::krui_setLearnFunc(char *learning_func)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int SnnsCLib::krui_checkPruning ()
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_getNetworkErrorArray(double **learnErrors,int **atEpoch,
				   int *noOfErrors)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_stopTraining(void)
{
    dotraining = FALSE;
    return(KRERR_NO_ERROR);
}
...
/*****************************************************************************
  ...
  UPDATE   : 19.02.95
******************************************************************************/
krui_err   SnnsCLib::krui_testAllPatterns(float *parameterInArray, int NoOfInParams,
                                float **parameterOutArray, int *NoOfOutParams)
/*  REMEMBER:  parameterOutArray[ 0 ] returns the current net error
               parameterInArray[ 0 ] contains the 1st learning parameter
*/
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err   SnnsCLib::krui_learnSinglePattern(int pattern_no, float *parameterInArray, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err   SnnsCLib::krui_testSinglePattern(int pattern_no, float *parameterInArray, 
				  int NoOfInParams, float **parameterOutArray, 
				  int *NoOfOutParams)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_learnAllPatternsFF (float *parameterInArray, int NoOfInParams,
                                  float **parameterOutArray, int *NoOfOutParams)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_learnSinglePatternFF (int pattern_no, float *parameterInArray,
                                    int NoOfInParams, float **parameterOutArray,
                                    int *NoOfOutParams)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_setPrunFunc (char *pruning_func)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_setFFLearnFunc (char *FF_learning_func)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_setClassDistribution(unsigned int *classDist)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_useClassDistribution(bool use_it)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setPatternNo(int pattern_no)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_getPatternNo(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_deletePattern(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_modifyPattern(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_showPattern(int mode)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_allocNewPatternSet(int *set_no)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_newPattern(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNoOfPatterns(void)
{
    int number;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getTotalNoOfSubPatterns(void)
{
    int number;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_deleteAllPatterns(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_shufflePatterns(bool on_or_off)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_shuffleSubPatterns(bool on_or_off)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setCurrPatSet(int number)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_deletePatSet(int number)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_GetPatInfo(pattern_set_info *set_info,
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_DefShowSubPat(int *insize, int *outsize, int *inpos, int *outpos)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_DefTrainSubPat(int *insize, int *outsize,
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_AlignSubPat(int *inpos, int *outpos, int *no)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_GetShapeOfSubPattern(int *insize, int *outsize,
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_saveNet(char *filename, char *netname)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_loadNet(char *filename, char **netname)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_loadNewPatterns(char *filename, int *set_no)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_saveNewPatterns(char *filename, int set_no)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_saveResultParam(char *filename, bool create,
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_allocateUnits(int no_of_units)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_deleteNet(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_getFirstSymbolTableEntry(char **symbol_name, int *symbol_type)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_getNextSymbolTableEntry(char **symbol_name, int *symbol_type)
{
    struct NameTable      *n_tbl;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
bool  SnnsCLib::krui_symbolSearch(char *symbol, int symbol_type)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_getNetInfo(int *no_of_sites, int *no_of_links, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_getMemoryManagerInfo(int *unit_bytes, int *site_bytes, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_getUnitDefaults(FlintType *act, FlintType *bias, int *st, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setUnitDefaults(FlintTypeParam act, FlintTypeParam bias, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void  SnnsCLib::krui_setSeedNo(long int seed)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNoOfInputUnits(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNoOfOutputUnits(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNoOfTTypeUnits(int UnitTType)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNoOfSpecialInputUnits(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getNoOfSpecialOutputUnits(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_xyTransTable(int op, int *x, int *y, int z)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_getUnitCenters(int unit_no, int center_no, 
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setUnitCenters(int unit_no, int center_no, 
			      struct PositionVector *unit_center)
{
    struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
float SnnsCLib::krui_NA_Error(int currentPattern, int error_unit, int error, bool ave)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_setSpecialNetworkType(int net_type)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int  SnnsCLib::krui_getSpecialNetworkType(void)
{
...
/*****************************************************************************
  ...
  UPDATE   : 06.02.92
******************************************************************************/
int SnnsCLib::krui_initInversion(void)
{
...
/*****************************************************************************
  ...
  UPDATE   : 29.01.92
******************************************************************************/
void  SnnsCLib::krui_inv_forwardPass(struct UnitList *inputs)
{
...
/*****************************************************************************
  ...
  UPDATE   : 04.02.92
*****************************************************************************/
double SnnsCLib::krui_inv_backwardPass(float learn, float delta_max, int *err_units,
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_MasPar(int mode )
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_getMasParStatus(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err  SnnsCLib::krui_MasParBenchmark(int func_type,int cycles,float  *result )
{
    float  parameterInArray[NO_OF_LEARN_PARAMS];
    float  *parameterOutArray;
    int  NoOfOutParams;
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void SnnsCLib::krui_kohonen_SetExtraParameter(int x)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void SnnsCLib::krui_spanning_tree(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void SnnsCLib::krui_cc_updatePosOfSpecialUnits(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_cc_deleteAllSpecialUnits(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
int SnnsCLib::krui_getErrorCode(void)
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
krui_err SnnsCLib::krui_setErrorHandler(void(* error_Handler )(int))
{
...
/*****************************************************************************
  ...
  UPDATE   :
******************************************************************************/
void SnnsCLib::krui_execHandler(int error_code)
{
