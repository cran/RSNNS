...
void SnnsCLib::pr_setInputPruning (int value)
{
...
void SnnsCLib::pr_setHiddenPruning (int value)
{
...
******************************************************************************/
 ...
 void SnnsCLib::pr_updateNoOfLinks (struct Unit *unit_ptr, struct Link *link_ptr)
...
void SnnsCLib::pr_checkDeadUnits (void)
...
krui_err SnnsCLib::pr_calcMeanDeviation (int pattern, float *sum_error)
...
******************************************************************************/
 ...
 void SnnsCLib::pr_mag_processLink (struct Unit *unit_ptr, struct Link *link_ptr)
...
krui_err SnnsCLib::PRUNE_Mag (int pattern)
...
******************************************************************************/
 ...
 void SnnsCLib::pr_obd_processLink (struct Unit *unit_ptr, struct Link *link_ptr,
...
******************************************************************************/
 ...
 void SnnsCLib::pr_obd_checkLink (struct Unit *unit_ptr, struct Link *link_ptr)
...
krui_err SnnsCLib::PRUNE_OBD (int pattern)

{
	     ...
	     unit_ptr = *(topo_ptr--))
	{
	    ...
	    deriv = (this->*unit_ptr->act_deriv_func) (unit_ptr);

	    delta = deriv * devit;
	    delta2 = devit * (this->*unit_ptr->act_2_deriv_func) (unit_ptr)
		+ deriv * deriv;
	     ...
	     unit_ptr = *(topo_ptr--))
	{
	    ...
	    delta2 =
		unit_ptr->value_a * (this->*unit_ptr->act_2_deriv_func) (unit_ptr)
...
void SnnsCLib::pr_obs_setInitParameter (float param)
...
******************************************************************************/
 ...
 void SnnsCLib::pr_obs_countLinks ()
...
******************************************************************************/
 ...
 void SnnsCLib::pr_obs_calculateDerivative (struct Link *link_ptr,
...
******************************************************************************/
 ...
 void SnnsCLib::pr_obs_calculateDerivVector (struct Unit *output_unit)
...
******************************************************************************/
 ...
 krui_err SnnsCLib::pr_obs_updateInverseHessian (int no_of_patterns)
...
******************************************************************************/
 ...
 krui_err SnnsCLib::pr_obs_calculateInverseHessian (int pattern)
...
******************************************************************************/
 ...
 void SnnsCLib::pr_obs_processLink (struct Unit *unit_ptr,
				struct Link *link_ptr,
				int weight_no)
...
******************************************************************************/
 ...
 void SnnsCLib::pr_obs_updateLink (struct Link *link_ptr,
			       float update_const,
			       int weight_no)
...
******************************************************************************/
 ...
 void SnnsCLib::pr_skel_processLink (struct Unit *unit_ptr, struct Link *link_ptr)
...
******************************************************************************/
 ...
 void SnnsCLib::pr_skel_check_saliency (struct Unit *unit_ptr)
...
krui_err SnnsCLib::PRUNE_Skeletonization (int pattern)

{
	   ...
	   unit_ptr = *(topo_ptr--))
	{
	  ...
	  if (unit_ptr->value_a > 0)
	    unit_ptr->value_a = (this->*unit_ptr->act_deriv_func) (unit_ptr);
	  else
	    if (unit_ptr->value_a < 0)
	      unit_ptr->value_a = - (this->*unit_ptr->act_deriv_func) (unit_ptr);
	    else
...
******************************************************************************/
 ...
 krui_err SnnsCLib::pr_nc_calc_stddev (int pattern, struct Unit *this_unit_ptr)
{
    struct Unit *unit_ptr;
...
******************************************************************************/
 ...
 void SnnsCLib::pr_nc_check_stddev (struct Unit *unit_ptr, struct Unit *unit_ptr2)
{
    float stddev;
...
******************************************************************************/
 ...
 krui_err SnnsCLib::pr_nc_process_succ_unit (struct Unit *unit_ptr, struct Link *link_ptr)
{ 
...
******************************************************************************/
 ...
 krui_err SnnsCLib::pr_nc_remove_unit (void)
{ 
    struct Unit *unit_ptr;
    struct Site *site_ptr;
    struct Link *link_ptr;
...
******************************************************************************/
 ...
 void SnnsCLib::pr_nc_clear_marks (void)
{
    struct Unit *unit_ptr;
...
******************************************************************************/
 ...
 void SnnsCLib::pr_nc_mark_all_pred (struct Unit *unit_ptr)
{
    struct Site *site_ptr;
    struct Link *link_ptr;
...
krui_err SnnsCLib::PRUNE_Noncontributing (int pattern)
{
    struct Unit *unit_ptr, *unit_ptr2;
...
krui_err SnnsCLib::pr_callPrunFunc (int pattern)
{
