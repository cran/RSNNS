...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void  SnnsCLib::kr_countUnits(struct Unit *unit_ptr, int mode)
{
  if (mode == UNIT_ADD)  {
    /*  add unit  */
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
struct Unit  *SnnsCLib::kr_getUnitPtr(int unit_no)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
FlintType  SnnsCLib::kr_getUnitValues(int unit_no, int component_selector)
{
  struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_setUnitValues(int unit_no, int component_selector, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_setAllUnitValues(int unit_no, FlintTypeParam out, 
...
******************************************************************************/
int  SnnsCLib::kr_makeDefaultUnit(void)
{
  struct Unit  *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_createUnit(char *unit_name, char *out_func_name, char *act_func_name, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_unitSetTType(int unit_no, int UnitTType)
{
  struct  Unit	*unit_ptr;
  int  intflags;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_setSite(int mode, char *site_name)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_setCurrUnit(int unit_no)
{
  struct Unit   *unit_ptr;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_getPredecessorUnit(int mode, FlintType *weight, float* val_a, float* val_b, float* val_c)
{
  ...
  switch (mode)
	...
	if (sitePtr == NULL)
	  ...
	  m_kernel_link_ptr = unitPtr->sites->links;
	else
	  m_kernel_link_ptr = sitePtr->links;
      }
      else
	m_kernel_link_ptr = (struct Link *) unitPtr->sites;

      linkPtr = m_kernel_link_ptr;
      prevLinkPtr = NULL;
      if (m_kernel_link_ptr == NULL)  return( 0 );  /*  No inputs   */

      *weight = m_kernel_link_ptr->weight;
    ...
    case  NEXT:
	 ...
	 return( 0 );
      ...
      prevLinkPtr = m_kernel_link_ptr;
      if ((linkPtr = m_kernel_link_ptr = m_kernel_link_ptr->next) == NULL)
	{
	prevLinkPtr = NULL;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_searchOutputConnection(struct Unit *start_unit_ptr, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_getSuccessorUnit(int mode, int source_unit_no, FlintType *weight)
{
  ...
  switch (mode)
    ...
    case  FIRST:  /*  first successor link wanted  */
      if ((m_kernel_source_unit_ptr = kr_getUnitPtr( source_unit_no )) == NULL)
	return( KernelErrorCode );

      sitePtr = NULL;  /*  no current Site  */
      unit_no = kr_searchOutputConnection( unit_array + MinUnitNo,
					   m_kernel_source_unit_ptr, weight );
      m_kernel_current_unit_ptr = unitPtr;
      m_kernel_current_site_ptr = sitePtr;

      return( unit_no );

    case  NEXT:  /*  next successor link wanted  */
      if (m_kernel_current_unit_ptr == NULL)
	{  /*  no current unit	*/
	KernelErrorCode = KRERR_NO_CURRENT_UNIT;
	return( 0 );
      }

      sitePtr = m_kernel_current_site_ptr;

      unit_no = kr_searchOutputConnection( m_kernel_current_unit_ptr + 1,
					   m_kernel_source_unit_ptr, weight );
      m_kernel_current_unit_ptr = unitPtr;
      m_kernel_current_site_ptr = sitePtr;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
FlintType  SnnsCLib::kr_getLinkWeight(void)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void  SnnsCLib::kr_setLinkWeight(FlintTypeParam weight)
{
  if (linkPtr != NULL)
    {
...
******************************************************************************/
 struct Link*  SnnsCLib::kr_createLinkWithAdditionalParameters
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_deleteAllLinks(int mode)
{
  if (unitPtr == NULL)
    {  /*  no current unit  */
    KernelErrorCode = KRERR_NO_CURRENT_UNIT;
...
krui_err SnnsCLib::kr_getCorrelatedHiddens(struct Unit **hn1, struct Unit **hn2, 
					double *res_corr)
{
    ...
    if (m_kernel_kr_CorrMatrix.rows < MyNoOfHidden || 
	m_kernel_kr_CorrMatrix.columns < MyNoOfHidden)
    {
	if (m_kernel_kr_CorrMatrix.field != NULL)
	    RbfFreeMatrix(&m_kernel_kr_CorrMatrix);

	if (!RbfAllocMatrix(MyNoOfHidden, MyNoOfHidden, &m_kernel_kr_CorrMatrix))
	{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
struct Site  *SnnsCLib::kr_createDefaultSite(void)
{
  struct Site   *site_ptr;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_copyUnitFrame(struct Unit *source_unit_ptr, 
				 struct Unit *new_unit_ptr)
{
  struct Site	*site_ptr,
		*new_site_ptr,
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_removeUnit(struct Unit *unit_ptr)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_copyUnit(int copy_mode, int source_unit)
{
  struct Unit	*source_unit_ptr,
		*new_unit_ptr;
  int  new_unit_no;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void    SnnsCLib::kr_changeFtypeUnit(struct Unit *unit_ptr, 
			   struct FtypeUnitStruct *ftype_ptr)
{
  FlagWord	flags;
  struct  Site  *site_ptr,
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void    SnnsCLib::kr_changeFtypeSites(struct FtypeUnitStruct *Ftype_entry, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_flags2TType(int flags)
{
  KernelErrorCode = KRERR_NO_ERROR;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_TType2Flags(int ttype)
{
  KernelErrorCode = KRERR_NO_ERROR;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void  SnnsCLib::kr_forceUnitGC(void)
{
  krm_unitArrayGC();
}
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void	SnnsCLib::kr_getUnitDefaults(FlintType *act, FlintType *bias, int *ttflags, 
			   ...
			   char **out_func)
{
  ...
  *layer_no     = DefaultLayerNo;
  ...
  strcpy( m_kernel_activation_func, krf_getCurrentNetworkFunc( ACT_FUNC ) );
  *act_func = m_kernel_activation_func;
  strcpy( m_kernel_output_func, krf_getCurrentNetworkFunc( OUT_FUNC ) );
  *out_func = m_kernel_output_func;
}
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_setUnitDefaults(FlintTypeParam act, FlintTypeParam bias, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void  SnnsCLib::DepthFirst1(struct Unit *unit_ptr, int depth)
{
  struct Site   *site_ptr;
  struct Link   *link_ptr;
  ...
  unit_ptr->lln = depth;  
  *kernel_global_topo_ptr++ = unit_ptr;  /*  store sorted unit pointer  */
}
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void  SnnsCLib::DepthFirst2(struct Unit *unit_ptr, int depth)
{
  struct Site   *site_ptr;
  struct Link   *link_ptr;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void  SnnsCLib::DepthFirst3(struct Unit *unit_ptr, int depth)
{
  struct Site   *site_ptr;
  struct Link   *link_ptr;
...
krui_err  SnnsCLib::kr_topoSortT(void)
{
  ...
  kernel_global_topo_ptr = topo_ptr_array;  /*  initialize global pointer */
...
krui_err  SnnsCLib::kr_topoSortFF(void)
{
  ...
  *kernel_global_topo_ptr++ = NULL;
  ...
  FOR_ALL_UNITS( unit_ptr )
	...
	KernelErrorCode = KRERR_I_UNITS_CONNECT;  /*  input unit has input  */
      ...
      io_units++;	/*  there is a input unit  */
      *kernel_global_topo_ptr++ = unit_ptr;  /*  save input unit  */
    }
  ...
  *kernel_global_topo_ptr++ = NULL;
  ...
  FOR_ALL_UNITS( unit_ptr )
    if (IS_OUTPUT_UNIT(unit_ptr ) && UNIT_IN_USE( unit_ptr ))
      *kernel_global_topo_ptr++ = unit_ptr;  /*  save output unit  */
...
int llncompare(const struct Unit **a, const struct Unit **b)
{ 
  int llndiff, lundiff;
...
krui_err  SnnsCLib::kr_topoSortLOG(void)
{
  struct Unit      *unit_ptr;
  TopoPtrArray     topo_ptr;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_topoSort(int topo_sorting_mode)
{
  KernelErrorCode = KRERR_NO_ERROR;  /*  reset return code  */
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_topoCheck(void)
{
  struct Unit   *unit_ptr;
  bool      o_units;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_callNetworkFunctionSTD(int type, float *parameterInArray, 
					   int NoOfInParams, 
...
//Rprintf("callNetworkFunctionSTD1\n");
  if ( (curr_func = krf_getCurrentNetworkFunc( type )) == NULL)
    return( KernelErrorCode );
//Rprintf("callNetworkFunctionSTD2\n");
  if (!krf_funcSearch( curr_func, type, &func_ptr ) )
    return( KernelErrorCode );
//Rprintf("callNetworkFunctionSTD3\n");
  KernelErrorCode = KRERR_NO_ERROR;
  net_func_ptr = (NetFunctionPtr) func_ptr;
//Rprintf("callNetworkFunctionSTD4\n");
  switch (type)  {
    case  UPDATE_FUNC:
//Rprintf("callNetworkFunctionSTD5\n");
      KernelErrorCode = 
	  (this->*(UpdateFuncPtr)net_func_ptr) ( parameterInArray, NoOfInParams );
      return( KernelErrorCode );

    case TEST_FUNC:
    case  LEARN_FUNC:
//Rprintf("callNetworkFunctionSTD6\n");
      if (kr_TotalNoOfPattern() == 0)
	{  /*  no patterns defined  */
	KernelErrorCode = KRERR_NO_PATTERNS;
	return( KernelErrorCode );
      }
//Rprintf("callNetworkFunctionSTD7\n");
	...
	return( KernelErrorCode );
      ...
      KernelErrorCode = 
	  (this->*(LearnFuncPtr)net_func_ptr) (start_pattern, end_pattern,
...
//Rprintf("callNetworkFunctionSTD8\n");
      /* check whether sub pattern fits onto network */
      if (NetModified)
	  kr_IOCheck();
      size = kr_SizeOfInputSubPat();
    ...
    case  INIT_FUNC:
//Rprintf("callNetworkFunctionSTD9\n");
      NetInitialize = TRUE;
      KernelErrorCode = 
	  (this->*(InitFuncPtr)net_func_ptr) ( parameterInArray, NoOfInParams );
//Rprintf("callNetworkFunctionSTD10\n");
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_callNetworkFunction(int type, float *parameterInArray, 
...
//Rprintf("callNetworkFunction2\n");

  KernelErrorCode = KRERR_NO_ERROR;

//Rprintf("callNetworkFunction3\n");

  switch (specialNetworkType)  {
    case NET_TYPE_GENERAL:
//Rprintf("callNetworkFunction4\n");
...
//Rprintf("callNetworkFunction5\n");
    ...
    case NET_TYPE_FF1:
      ...
      m_kernel_net_func_params.start_pattern_no = start_pattern;
      m_kernel_net_func_params.end_pattern_no   = end_pattern;
      m_kernel_net_func_params.no_of_input_parameters = NoOfInParams;

      memcpy( m_kernel_net_func_params.input_parameters, parameterInArray,
              sizeof (float) * NoOfInParams );

      (void) krff_callMasParNetworkFunction( type, &m_kernel_net_func_params );

      if (NoOfOutParams != NULL)
        *NoOfOutParams = m_kernel_net_func_params.no_of_output_parameters;
      if (parameterOutArray != NULL)
        *parameterOutArray = m_kernel_net_func_params.output_parameters;
...
krui_err  SnnsCLib::kr_xyTransTable(int op, int *x, int *y, int z)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_setSpecialNetworkType(int net_type)
{
  KernelErrorCode = KRERR_NO_ERROR;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_getSpecialNetworkType(void)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_validateOperation(void)
{
  switch (specialNetworkType)
    {
    case NET_TYPE_GENERAL:
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_initMasPar(int mode )
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err  SnnsCLib::kr_getMasParStatus(void)
{
  KernelErrorCode = KRERR_NO_ERROR;
