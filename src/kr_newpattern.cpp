...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_setCurrPatSet(int number)
{
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_deletePatSet(int number)
{
    int i;
    int pat_set;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_GetPatInfo(pattern_set_info *set_info, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_DefShowSubPat(int *insize, int *outsize, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_DefTrainSubPat(int *insize, int *outsize, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_AlignSubPat(int *inpos, int *outpos, int *no)
{
    krui_err err_code;
    np_pattern_descriptor *p;
    int pos;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_allocNewPatternSet(int *set_no)
{
    int pat_set;
    krui_err err_code;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_loadNewPatterns(char *filename, int *set_no)
{
    FILE *infile;
    int pat_set;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_saveNewPatterns(char *filename, int set_no)
{
    FILE *outfile;
    krui_err err_code;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_GetShapeOfSubPat(int *insize, int *outsize, 
...
description.
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_setRemapFunction(char *name, float *params)
{
...
the real distribution of the pattern set.
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_setClassDistribution(unsigned int *class_sizes)
{
    int has_changed = 0;
    krui_err err_code = KRERR_NO_ERROR;
...
reused several times during one epoch.
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_useChunk(bool active)
{
    krui_err err_code = KRERR_NO_ERROR;
...
If the given class name is the NULL pointer, nothing happens at all.
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_npui_setClass(char *classname)
{
    np_pattern_descriptor *p;
    krui_err err_code = KRERR_NO_ERROR;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int  SnnsCLib::kr_np_pattern(int mode ,int mode1 ,int pattern_no)
{
    int return_code;
    int new_pattern;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_initSubPatternOrder(int start, int end)
{
    int pat_set;
    int n_sub;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
bool SnnsCLib::kr_getSubPatternByOrder(int *pattern, int *sub)
{
    int n_sub;
	...
	TRACE_RETURN((kr_getSubPatternByNo(pattern, sub, 
				     u_lrand48() % np_random_train_number)));
    }
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int SnnsCLib::kr_TotalNoOfSubPatPairs(void)
{
    int n;
    int i;
    int sum;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int SnnsCLib::kr_AbsPosOfFirstSubPat(int pattern)
{
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int SnnsCLib::kr_TotalNoOfPattern(void)
{
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
Patterns SnnsCLib::kr_getSubPatData(int pat_no, int sub_no, int io_type, int *size)
{
    int set;
    np_pattern_descriptor *pat;
...
/*****************************************************************************
  ...
  UPDATE   : 
*****************************************************************************/
int SnnsCLib::kr_getSubPatClass(int pat_no, int sub_no)
{
    int set;
    np_pattern_descriptor *pat;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int SnnsCLib::kr_SizeOfInputSubPat(void)
{
    krui_err err;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
int SnnsCLib::kr_SizeOfOutputSubPat(void)
{
    krui_err err;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_np_AllocatePatternSet(int *pat_set, int number)
{
    krui_err err_code;
    int i;
    int set = -1;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_np_AllocatePattern(np_pattern_descriptor *pattern,
			       bool input)
{
    int i;
    int size;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
void SnnsCLib::kr_np_FreePattern(np_pattern_descriptor *pattern)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_np_GetDescriptor(int pat_set, int number, 
			     np_pattern_descriptor **pattern)
{
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
krui_err SnnsCLib::kr_np_lookupSym(int pat_set, char *symbol, struct np_symtab **entry)
{
    struct np_symtab *list;
...
#ifdef DEBUG_PATTERN
 SnnsCLib::print_page_info(struct patternpage *page)
{
    int fl;
    int cnt;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 float *SnnsCLib::kr_np_floatmalloc(int size)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 void SnnsCLib::kr_np_floatfree(float *ptr)
{
    struct patternpage *page;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_InitPattern(void)
{
    int i;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_ReallocatePatternSet(int pat_set, int new_number)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_DeletePatternSet(int pat_set)
{
    int i;
    np_pattern_descriptor *p;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_DeletePattern(int pat_set, int pattern)
{
    np_pattern_descriptor *p;
    int i;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 void SnnsCLib::kr_np_delSym(int pat_set, struct np_symtab *entry)
{
    struct np_symtab *list;
    struct np_symtab *last = NULL;
    int i;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_AddPattern(int pat_set, int *pattern)
{
    krui_err err;
    np_pattern_descriptor *p;
    int number;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_LoadPatternFile(FILE *pat_file, int *pat_set)
{
    int i;
    bool free;
    krui_err err_code = KRERR_NO_ERROR;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_SavePatternFile(FILE *out_file, int pat_set)
{
    np_pattern_set_info info;
    krui_err err_code;
    int i, j, n;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_GetInfo(int pat_set, np_pattern_set_info *info)
{
    krui_err err_code;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_ValidateInfo(int pat_set)
{
    int i, j;
    np_pattern_descriptor *p;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_GetSubPatSizes(int *input_size, int *output_size)
{
    int pat_set;
    np_pattern_descriptor *pattern;
    int i;
...
The parameter entries returns the number of entries in the data field.
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_GetSubPat(bool input, int *pos_coord, int *size_coord,
...
The parameter entries returns the number of entries in the data field.
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_SetSubPat(bool input, int *pos_coord, int *size_coord,
				float *data, int entries)
{
    int u_dim;                   /* copy of all necessary variables from */
    int u_size;                  /* pattern descriptor, depending on */
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 bool SnnsCLib::kr_np_align_sub_pos(int dim, int *n, int *psize, int *ssize, 
				int *sstep, int *spos)
{
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 bool SnnsCLib::kr_np_gen_sub_pos(int dim, int *n, int *psize, int *ssize, 
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 bool SnnsCLib::kr_np_allocate_pat_train_entries(int n)
{
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 bool SnnsCLib::kr_np_allocate_sub_pat_train_entries(int n)
{
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 bool SnnsCLib::kr_np_allocate_pat_mapping_entries(int n)
{
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 void SnnsCLib::kr_np_order_chunk_arrays(bool shuffle, int pattern_set)
{
    struct np_symtab *list;
    np_pattern_descriptor *pattern;
    int no_of_pattern;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 void SnnsCLib::kr_np_fill_virtual_to_void_mapping(int pat_set)
{
    struct np_symtab *list;
    int insert_pos;
    int chunk_size;
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 int SnnsCLib::kr_np_virtual_to_physical(int vnum)
{
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 int SnnsCLib::kr_np_physical_to_virtual(int pnum)
{
    int vnum;
    TRACE_IN();
...
/*****************************************************************************
  ...
  UPDATE   : 
******************************************************************************/
 krui_err SnnsCLib::kr_np_DefineSubPatternOrdering(int pat_set, bool input, 
					       int *size_coord, 
					       int *incr_coord)
{
    krui_err err_code;
